...
#    echo ${1//" "}${OUTDATE} $MAXELEV
    ...
    echo "/home/machs/weather/predict/receive_and_process_satellite.sh \"${1}\" $2 /mnt/ramDrive/${FILENAME} /home/machs/weather/predict/weather.tle $var1 $TIMER" | at `date --date="TZ=\"UTC\" $START_TIME" +"%H:%M %D"`
#    echo "/home/machs/weather/predict/receive_and_process_satellite.sh \"${1}\" $2 /home/machs/weather/${1//" "}${OUTDATE} /home/machs/weather/predict/weather.tle $var1 $TIMER" | at `date --date="TZ=\"UTC\" $START_TIME" +"%H:%M %D"`
fi
