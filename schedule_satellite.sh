...
#    echo ${1//" "}${OUTDATE} $MAXELEV
    ...
    echo "/home/machs/skywaveRX/receive_and_process_satellite.sh \"${1}\" $2 /mnt/ramDrive/${FILENAME} /home/machs/skywaveRX/weather.tle $var1 $TIMER" | at `date --date="TZ=\"UTC\" $START_TIME" +"%H:%M %D"`
fi
